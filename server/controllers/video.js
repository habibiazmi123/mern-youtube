...
export const updateVideo = async (req, res, next) => {
    try {
        ...
        if(req.user.id !== video.userId) return next(createError(404, 'You can only update your video.'));
...
export const deleteVideo = async (req, res, next) => {
    ...
    if(req.params.id !== video.userId) return next(createError(403, 'You can only delete your video.'));
